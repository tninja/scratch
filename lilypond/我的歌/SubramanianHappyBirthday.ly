...
\header {
  ...
  lastupdated = "2018/April/26"
  title = "Happy Birthday, Mr. Subramanian"
  subtitle = "Thanks for all the helps"
  subsubtitle = "Midi file is available upon request"
}
...
verseen = \new Lyrics \lyricsto "one" {
  \lyricmode {
	...
	Hap -- py birth -- day to Subramanian , | hap -- py birth -- day to you !
	Hap -- py birth -- day to you , | hap -- py birth -- day to you ,
	Hap -- py birth -- day to Subramanian , | hap -- py birth -- day to you !
	Hap -- py birth -- day to you , | hap -- py birth -- day to you ,
	Hap -- py birth -- day to Subramanian , | hap -- py birth -- day to you !
...
\score
{
  ...
  \midi {
	\tempo 2 = 72
	%% convert to mp3 (for iphone) timidity ./Subramanian生日快乐歌.midi -Ow -o - | lame - -b 64 Subramanian生日快乐歌.mp3
  }
  \layout { }
}
