...
\header {
  ...
  title = "生日快乐 钢琴谱"
  subtitle = "John祝Bella妹妹生日快乐"
}

\markup {
  \fill-line {
	\center-align {
	  \epsfile #X #80 #"bella.eps"
	}
  }
}
...
verseen = \new Lyrics \lyricsto "one" {
  \lyricmode {
	...
	Hap -- py birth -- day to Bella , | hap -- py birth -- day to you !
	Hap -- py birth -- day to you , | hap -- py birth -- day to you ,
	Hap -- py birth -- day to Bella , | hap -- py birth -- day to you !
	Hap -- py birth -- day to you , | hap -- py birth -- day to you ,
	Hap -- py birth -- day to Bella , | hap -- py birth -- day to you !
...
\score
{
  ...
  \midi {
	\tempo 2 = 72
	%% convert to mp3 (for iphone) timidity ./Bella生日快乐歌.midi -Ow -o - | lame - -b 64 Bella生日快乐歌.mp3
  }
  \layout { }
}
